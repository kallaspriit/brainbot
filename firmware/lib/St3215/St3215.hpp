...
class St3215 {
  public:
    ...
    struct ServoInfo {
        ...
        int positionKp = 0;     // Position loop proportional gain (0..255)
        int positionKd = 0;     // Position loop derivative gain (0..255)
        int positionKi = 0;     // Position loop integral gain (0..255)
        bool isValid = false;
    };
